...
using SuperKudos.Aggregator.Queues;
using SuperKudos.Aggregator.Services;
using SuperKudos.Aggregator.Services.Rest;
using MyKudos.MessageSender.Interfaces;
using MyKudos.Queue.Services;
using System.Globalization;
using System.Text.Json.Serialization;
using System.Text.Json;
using SuperKudos.Aggregator.Grpc;
using Dapr.Client;
...
app.MapGrpcService<KudosGrpcService>();
app.MapGrpcService<KudosAggregadorService>();
