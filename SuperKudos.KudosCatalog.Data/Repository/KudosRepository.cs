...
public class KudosRepository : IKudosRepository
{
	...
	public int Add(SuperKudos.KudosCatalog.Domain.Models.Kudos kudos)
	{
    ...
    public SuperKudos.KudosCatalog.Domain.Models.Kudos? GetKudos(int kudosId)
    {
    ...
    public async Task<IEnumerable<SuperKudos.KudosCatalog.Domain.Models.Kudos>> GetKudosAsync(int pageNumber = 1, int pageSize=5)
	{
    ...
    public async Task<IEnumerable<SuperKudos.KudosCatalog.Domain.Models.Kudos>> GetKudosFromMeAsync(Guid pUserId, int pageNumber = 1, int pageSize = 5)
    {
    ...
    public async Task<IEnumerable<SuperKudos.KudosCatalog.Domain.Models.Kudos>> GetKudosToMeAsync(Guid pUserId, int pageNumber = 1, int pageSize = 5)
    {
    ...
    public IEnumerable<SuperKudos.KudosCatalog.Domain.Models.Kudos> GetUserKudos(Guid pUserId)
    {
